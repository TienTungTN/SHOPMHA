...
<div><marquee behavior="alternate" class="chaychu" >Chào mừng quý khách đến với cửa hàng MHA Shop. Chúc quý khách một ngày tốt lành.</marquee></div><br>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  				...
  				<div class="carousel-inner">
    				...
    				<div class="carousel-item">
      					<img class="d-block w-100 h-50" src="https://cf.shopee.sg/file/c304cae0e031006e356858f48882bdd6" alt="Second slide">
    				</div>
    				<div class="carousel-item">
		...
		<div class="footer">
			...
			<div class="footer__bottom">
				<div class="grid wide">
					<p>© 2021 - Bản quyền thuộc về công ty MHA</p>
				</div>
			</div>
		</div>
