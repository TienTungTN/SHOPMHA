...
<html>
<head>
	<title>MHA SHOP | Trang chủ</title>
	<meta charset="utf-8">
		...
		<div class="header">
			<div class="grid wide">
				<div class="header-main">
					<div class="logo">
					<a href="./index.php"><img src="./img/LOGO1.png" width="250" height="120"></a>
					</div>
					<div class="search">
...
<div><marquee behavior="alternate" class="chaychu" >Chào mừng quý khách đến với cửa hàng MHA. Chúc quý khách một ngày tốt lành.</marquee></div><br>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  				...
  				<div class="carousel-inner">
    				<div class="carousel-item active">
    					 <img class="d-block w-100 " src="./img/banner/1.png"alt="First slide" width="auto" height="auto">
   					<!-- </div> -->
    				<!-- <div class="carousel-item">
      					<img class="d-block w-100 h-50" src="./img/banner/banner2.png" alt="Second slide">
    				</div>
    				<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner3.png" alt="Third slide">
   					</div>
   					<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner4.png" alt="Fourth slide">
   					</div>
					   <div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner5.png" alt="Fifth slide"">
   					</div>
					   <div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner6.png" alt="Sixth slide">
   					</div> -->
  				<!-- </div> -->
        ...
        ?>
						...
						<?php
							...
							<a class="home-product-item" href="./pages/sanpham.php?id= '.$row['id'].'">
								...
								<h4 class="home-product-item__gia">'.number_format($row['giasp'],3).'</h4>
		...
		<div class="footer">
			...
			<div class="footer__bottom">
				<div class="grid wide">
					<p>© 2024 - Bản quyền thuộc về MHA Shop</p>
				</div>
			</div>
		</div>
