...
<html>
<head>
	<title>MHA SHOP | Giới thiệu</title>
	<meta charset="utf-8">
...
<form action="../timkiem.php" method="POST">
	<div class="app">
			...
			<div class="grid wide">
				<div class="header-main">
					...
					<div class="contact">
						...
						<p>Email: <a href="mailto:MHAShop@gmail.com" style="color: #333;">MHAShop@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footer">
			<div class="grid wide">
                <h3 class="h3">Giới thiệu về Shop thời trang MHA</h3><br>
                ...
                <p>Phần trở ngại lớn ở đây là giá tiền của những bộ quần áo chính hãng thì quá cao so với đa phần các 
                    bạn trẻ, vì thế mình đã tìm tòi và tạo ra MHA SHOP để nhằm đưa đến cho các bạn có niềm yêu thích những đôi 
                    quần áo cá tính này với một mức giá hấp dẫn kèm với chất lượng tốt nhất trong tầm giá. <br>
                    Với tiêu chí mức giá hợp lý, vừa túi tiền nhưng chất lượng lại tốt hơn so với những gì các bạn lại bỏ ra, 
                    MHA SHOP hứa sẽ luôn luôn đưa đến người của bạn chất lượng quần áo đảm bảo tốt nhất.
                </p>
                <h4 class="h4">Tiêu chí bán hàng</h4>
                <p>Tiêu chí bán hàng tại quần áo Nation đó là làm hài lòng khách hàng tối đa!</p>
                <ul>
                ...
                <p>Tất cả sản phẩm quần áo, dép tại MHA SHOP là những mẫu quần áo chính hãng
                    quần áo Yody… Đều được dựa trên nguyên bản gốc của các hãng quần áo yody, quần áo gucci
                </p>
               
                <p>
                    Về phần đế quần áo được làm bằng chất liệu cùng với chất liệu hàng chính hãng, nhẹ, êm và bền, 
                    thoải mái cho người đi. Với chất lượng gia công tốt, hoàn thiện chuẩn với hàng chính hãng nhằm 
                    giúp cho bạn thỏa đam mê các dòng quần áo cao cấp.
                </p>
                <p>
                    Độ bền của sản phẩm luôn được đảm bảo từ 12 – 18 tháng, thông tin được chính mình trải nghiệm và 
                    nhiều khách hàng sở hữu quần áo của shop gửi về cho mình.
                </p>
                <p>
                    Hãy để mình làm 1 phép tính đơn giản, bạn bỏ số tiền 300k để mua 1 bộ quần áo Yody hàng chính hãng, 
                    trong khi cùng số tiền đó, bạn có thể sở hữu được từ 4 – 5 mẫu quần áo khác nhau, với màu sắc và 
                    thiết kế khách nhau để bạn có thể thoải mái phối được với nhiều bộ đồ của mình mà không phải nhàm chán.
                </p>
                <p>
                    Chính vì thế mà MHA SHOP muốn được là người đưa đến cho các bạn nhiều mẫu quần áo hơn, được tiếp cận 
                    với những mẫu quần áo huyền thoại, hoặc những mẫu quần áo mới được ưa chuộng trên thế giới.
                </p>
		...
		<div class="footer">
			...
			<div class="footer__bottom">
				<div class="grid wide">
					<p>© 2021 - Bản quyền thuộc về công ty MHA SHOP</p>
				</div>
			</div>
		</div>
