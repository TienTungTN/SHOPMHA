			...
			<div class="grid wide">
				<div class="header-main">
					...
					<div class="contact">
						...
						<p>Email: <a href="mailto:anhtai09042002@gmail.com" style="color: #333;">MHA SHOPshop@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="prodoct-detail-info">
					...
					<div class="grid__column-right">
						...
						<div class="product-detail-ship">
							<label class="product-detail-label-lb" style="width: 100px;">Vận chuyển</label>
						...
						<div class="product-detail-quantity">
							<div class="product-detail-label-lb" style="width: 100px;">Số lượng</div>
				...
				<div class="product-detail-decribe">
					<div class="product-detail-describe__detail">
						...
						<div class="product-detail-describe__detail-content">
							...
							<div class="product-detail-describe__detail-content-row">
								<label class="product-detail-describe-label">Dáng quần áo</label>
								<div class="product-detail-describe__detail-content-column">
									Đẹp, phù hợp với nhiều loại người
								</div>
							</div>
							<div class="product-detail-describe__detail-content-row">
								<label class="product-detail-describe-label">Chiều dài quần áo</label>
								<div class="product-detail-describe__detail-content-column">
									Dài
								</div>
							</div>
							...
							<div class="product-detail-describe__detail-content-row">
								<label class="product-detail-describe-label">Loại quần áo</label>
								<div class="product-detail-describe__detail-content-column">
