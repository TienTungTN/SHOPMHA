...
<form action="../timkiem.php" method="POST">
	<div class="app">
			...
			<div class="grid wide">
				<div class="header-main">
					...
					<div class="contact">
						...
						<p>Email: <a href="mailto:TT MHAShop@gmail.com" style="color: #333;">TT MHAShop@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footer">
			<div class="grid wide">
                <h3 class="h3">Liên hệ Shop thời trang MHA</h3><br>
                <div>
                   <p>Facebook: <a href="https://www.facebook.com/">Cửa hàng thời trang MHA Shop</a></p> 
                </div>
                <div class="contact">
						<p>Hotline: 0123456789</p>
						<p>Email: <a href="mailto:TTShoesshop@gmail.com" style="color: #333;">MHAShop@gmail.com</a></p>
				</div>
