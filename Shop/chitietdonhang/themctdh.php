...
session_start();
  ...
  $soluong = $_POST['soluong'];
			...
			$sql= "INSERT INTO `chitietdonhang` (`id`, `iddonhang`, `idsp`, `soluong`) VALUES ('$id','$iddonhang','$idsp','$soluong')";
...
<html>
<head>
	<title>MHA SHOP | Thêm danh mục</title>
	<meta charset="utf-8">
			...
			<div class="grid wide">
				<div class="header-main">
					...
					<div class="contact">
						...
						<p>Email: <a href="mailto:MHA SHOPshop@gmail.com" style="color: #333;">MHA SHOPshop@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
						...
						<ul class="navbar-category-list">
							...
							<?php
										...
										while($row=mysqli_fetch_array($ketqua)){
											echo '<a href="../chitietdonhang.php?idchitietdonhang= '.$row['id'].'" class="category-item__link">'.$row['id'].'</a>';
										}
									?>
							</li>
						</ul>
		...
		<div class="container">
			<div class="grid wide">
					...
					<div class="column l-2 me-0 s-0">
						<nav class="category">
							<h3 class="category-heading" align="center">
								<p >***</p>
								<a href="themdm.php">Thêm vào kho</a>
								<p></p>
								<p  >***</p>
							</h3>
							<ul class="category-list">
								<li class="category-item category-item--active">
									<a href="./quanlyctdh.php" ><- Quay lại </a>
								</li>
							</ul>
						</nav>
					</div>
				...
				<div class="product-detail-decribe" align="center">
					...
					<h3>Thêm vào kho sản phẩm mới</h3><br>
            <table>
	<form action="" enctype="multipart/form-data" method="POST">
	<tr> <td>	ID: </td>
	<td><input type="text" name="id" size="50"></td>
	</tr>
    <tr> <td>	ID đơn hàng: </td>
	<td><input type="text" name="iddonhang" size="50"></td>
	</tr>
    <tr> <td>	ID sản phẩm: </td>
	<td><input type="text" name="idsp" size="50"></td>
	</tr>
    <tr> <td>	Số lượng: </td>
	<td><input type="text" name="soluong" size="50"></td>
	</tr>
  	<tr>
      <td></td>    
      <td align="center"> <input type="submit" name="submit"  value="Thêm vào kho" ></td></tr>
	</form>
	</table>
					</div>	
				</div>
