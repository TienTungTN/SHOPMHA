...
<div><marquee behavior="alternate" class="chaychu" >Chào mừng quý khách đến với cửa hàng MHA Shop. Chúc quý khách một ngày tốt lành.</marquee></div><br>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  				...
  				<div class="carousel-inner">
    				<div class="carousel-item active">
    					 <img class="d-block w-100 h-50" src="./img/banner/1.png" alt="one slide">
   					</div>
    				<div class="carousel-item">
      					<img class="d-block w-100 h-50" src="./img/banner/banner2.png" alt="two slide">
    				</div>
    				<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner3.png" alt="three slide">
   					</div>
   					<div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner4.png" alt="four slide">
   					</div>
					   <div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner5.png" alt="five slide">
   					</div>
					   <div class="carousel-item">
     					<img class="d-block w-100 h-50" src="./img/banner/banner6.png" alt="six slide">
   					</div>
  				</div>
		...
		<div class="footer">
			...
			<div class="footer__bottom">
				<div class="grid wide">
					<p>© 2024 - Bản quyền thuộc về công ty MHA</p>
				</div>
			</div>
		</div>
