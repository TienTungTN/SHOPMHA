...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        if ($_FILES['uploadFile']['name'] != NULL) {
            ...
            // Trường hợp không có ảnh mới upload, giữ nguyên ảnh cũ
            $hinhanh = $_POST['existing_image'];
        }
...
<html>
<head>
	<title>MHA SHOP | Sửa sản phẩm</title>
	<meta charset="utf-8">
...
<form action="../timkiem.php" method="POST">
 ...
 <?php
   ...
   <tr> <td>	ID: </td>
   <td><input type="text" name="id" size="100" value="<?php echo $row['id'] ?>"></td>
   </tr>
