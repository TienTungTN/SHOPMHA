...
if (isset($_POST['submit'])) {
  ...
  $sql= "INSERT INTO sanpham (tensp, giasp, mota,hinhanh,soluong,mau,size,iddanhmuc) VALUES ('$tensp',  $giasp, '$mota','$hinhanh',$soluong,'$mau',$size,$iddanhmuc)";
...
<html>
<head>
	<title>MHA SHOP | Thêm sản phẩm</title>
	<meta charset="utf-8">
