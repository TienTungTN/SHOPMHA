		...
		<div class="header">
			<div class="grid wide">
				<div class="header-main">
					<div class="logo">
						<a href="../index.php"><img src="../img/logo.png" width="200" height="100"></a>
					</div>
					<div class="search">
					...
					<div class="column l-2 me-0 s-0">
						<nav class="category">
							<h3 class="category-heading">
								<p align="center">***</p>
								<a href="themdm.php">Sửa bình luận</a>
								<p></p>
								<p align="center">***</p>
							</h3>
							<ul class="category-list">
								<li class="category-item category-item--active">
									<a href="./quanlybl.php" ><- Quay lại </a>
								</li>
							</ul>
						</nav>
					</div>
...
<div >
    ...
    <table >
    <tr><td>Tên bình luận:     <input type="text" name="tendanhmuc" value="<?php echo $thongtinsv['tendanhmuc']; ?>"></td>	</tr>
	<tr><td align="center">   <input type="submit" value="Sửa bình luận"></td>      </tr>
    </table>         
	</form>
	</div>
					</div>	
